...
import { creerEquipe, archiverEquipe } from "./actions";
    ...
    <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col px-5 py-10">
      ...
      <div className="mt-6 flex flex-col gap-2">
        {(teams ?? []).map((t) => (
          ...
          >
            <div>
              <p className="font-condensed text-lg font-semibold uppercase text-rof-texte">
                {t.name} {t.archived && <span className="text-rof-gris">(archivée)</span>}
              </p>
